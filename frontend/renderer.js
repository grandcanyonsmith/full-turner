 ...
 * @param {Object} element - Funnel element
 ...
 * @param {Array} funnelJson - Funnel JSON array
 * @param {string} pattern - Pattern to match (e.g., 'opt_pain_*')
 * @returns {Array} - Sorted array of matching elements
 */
function getElementsByPattern(funnelJson, pattern) {
    if (!funnelJson || !Array.isArray(funnelJson)) return [];
 ...
 * @param {Array} funnelJson - Funnel JSON array
 * @param {string} pattern - Pattern to match (e.g., 'opt_pain_*')
 * @returns {Array} - Array of element values
 */
function getElementsByPatternAsValues(funnelJson, pattern) {
...
export {
    ...
    getColor,
    getElementValue,
    getElementsByPattern,
    getElementsByPatternAsValues,
    renderOptInPage,
    renderThankYouPage,
    renderDownloadPage,
    renderEmailPreview,
